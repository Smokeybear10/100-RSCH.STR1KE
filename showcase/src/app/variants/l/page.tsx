  ...
  return (
    <>
      ...
      <main className="relative z-10 bg-black text-white font-[family-name:var(--font-barlow)] overflow-x-hidden">
        ...
        {/* ══════════════════════════════════════════════════════════════ */}
        <div className="sticky top-0 z-40 bg-black border-b-[3px] border-[#dc2626] shadow-[0_4px_20px_rgba(220,38,38,0.2)]">
        ...
        {/* ══════════════════════════════════════════════════════════════ */}
        {/* HERO — MAIN EVENT title card (restored from Fight)              */}
        {/* ══════════════════════════════════════════════════════════════ */}
        ...
        {/* ══════════════════════════════════════════════════════════════ */}
        {/* HIGHLIGHT REEL — stat callouts, count-up on numbers             */}
        {/* ══════════════════════════════════════════════════════════════ */}
        ...
        {/* ══════════════════════════════════════════════════════════════ */}
        <section className="py-32 px-5 border-t-2 border-[#dc2626]/30 relative">
        ...
        {/* ══════════════════════════════════════════════════════════════ */}
        <section className="py-32 px-5 border-t-2 border-[#dc2626]/30">
          <div className="max-w-[980px] mx-auto">
            ...
            <SlamIn variant="clip-reveal" delay={300}>
              <div className="mt-14 border-[3px] border-[#dc2626] bg-[#0a0000] p-6 shadow-[0_0_40px_rgba(220,38,38,0.2)]">
                ...
                >
                  <defs>
                    <linearGradient id="l-fc-grad" x1="0" y1="0" x2="0" y2="1">
