...
export default function VariantCinematic() {
  return (
    <main className="cinematic-chrome relative z-10 bg-black text-white font-[family-name:var(--font-barlow)] overflow-x-clip">
      {/* ══════════════════════════════════════════════════════════════ */}
